...
const KO: Dict = {
  ...
  'export.dbScreenAll': 'DB–Screen (전체)',
  'export.routes': '개 라우트',
  'export.tables': '개 테이블',
  ...
  'msg.noWorkspace': 'CodeSight: No workspace folder open.',
  'msg.noCacheRunFirst': 'CodeSight: No analysis cache. Run Analyze first.',
  'msg.staticComplete': 'CodeSight: Static analysis complete. Enable LLM analysis for richer results.',
  'msg.llmNoApiKey': 'CodeSight: LLM analysis enabled but no API key found. Set one first.',
  'msg.analysisFailed': 'CodeSight: Analysis failed — {message}',
  'msg.apiKeySaved': 'CodeSight: API key saved securely.',
  'msg.apiKeyCleared': 'CodeSight: API key cleared.',
...
const EN: Dict = {
  ...
  'card.fk': 'FK',
  'card.usedBy': 'Used by',
  'export.dbScreenAll': 'DB–Screen (All)',
...
const JA: Dict = {
  ...
  'card.fk': 'FK',
  'card.usedBy': '使用元',
  'export.dbScreenAll': 'DB–Screen (全て)',
  'export.routes': ' ルート',
  'export.tables': ' テーブル',
  ...
  'msg.noWorkspace': 'CodeSight: ワークスペースフォルダーが開かれていません。',
  'msg.noCacheRunFirst': 'CodeSight: 分析キャッシュがありません。先に分析を実行してください。',
  'msg.staticComplete': 'CodeSight: 静的分析が完了しました。LLM分析を有効化するとさらに詳細な結果が得られます。',
  'msg.llmNoApiKey': 'CodeSight: LLM 分析が有効ですが API キーがありません。先に設定してください。',
  'msg.analysisFailed': 'CodeSight: 分析失敗 — {message}',
  'msg.apiKeySaved': 'CodeSight: API キーを安全に保存しました。',
  'msg.apiKeyCleared': 'CodeSight: API キーを削除しました。',
...
const ZH_CN: Dict = {
  ...
  'card.fk': 'FK',
  'card.usedBy': '使用方',
  'export.dbScreenAll': 'DB–Screen (全部)',
  'export.routes': ' 路由',
  'export.tables': ' 表',
  ...
  'msg.noWorkspace': 'CodeSight: 未打开工作区文件夹。',
  'msg.noCacheRunFirst': 'CodeSight: 无分析缓存。请先运行分析。',
  'msg.staticComplete': 'CodeSight: 静态分析完成。启用 LLM 分析可获得更丰富的结果。',
  'msg.llmNoApiKey': 'CodeSight: 已启用 LLM 分析但未找到 API Key。请先设置。',
  'msg.analysisFailed': 'CodeSight: 分析失败 — {message}',
  'msg.apiKeySaved': 'CodeSight: API Key 已安全保存。',
  'msg.apiKeyCleared': 'CodeSight: API Key 已清除。',
